...
response.setContentType("text/html");			
 ...
 pw.println("<body>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			String  type1=null;
			if(data.getType().equals("trackers")){
				type1="PetTrackers";
			}else if(data.getType().equals("laptops")){
				//pw.print(data.getType());
				type1="laptops";
			}else if(data.getType().equals("headphones")){
				type1="HeadPhones";
			}else if(data.getType().equals("fitnesswatches")){
				type1="fitnesswatches";
			}else if(data.getType().equals("smartwatches")){
				type1="smartwatches";
			}else if(data.getType().equals("speakers")){
				type1="Speakers";
			}else if(data.getType().equals("phones")){
				type1="phones";
			}else if(data.getType().equals("virtualrealities")){
				type1="VirtualReality";
