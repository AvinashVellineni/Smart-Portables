...
public class ProductCrud extends HttpServlet {
	protected void doGet(HttpServletRequest request,
			...
			if(action.equals("add"))
			{
			  ...
			  else if (producttype.equals("virtualrealities"))
			  {
				  allvirtualrealities = MySqlDataStoreUtilities.getVirtualReality();
				  if(allvirtualrealities.containsKey(productId)){
					  msg = "Product already available";
				  }
			  }
			  else if (producttype.equals("trackers"))
			  {
				  alltrackers = MySqlDataStoreUtilities.getTrackers();
				  if(alltrackers.containsKey(productId)){
					  msg = "Product already available";
				  }
			  }
