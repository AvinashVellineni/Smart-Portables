...
public class FitnessWatchList extends HttpServlet {
	...
	/* Checks the Tablets type whether it is microsft or apple or samsung */
		...
		String name = null;
		String CategoryName = "FitnessWatch";
		...
		for (Map.Entry<String, FitnessWatch> entry : hm.entrySet()) {
			...
			if (i % 1 == 1)
				...
				pw.print("<td style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 14px;font-weight: bold;font-color: black !important;color: #d80a14;'>"+FitnessWatch.getName()+"</td>");
				pw.print("<td id='item'><img style='padding-top: 10px;padding-bottom: 10px;margin-bottom: -3px;width: 80%;height: 150px;' src='images/fitnesswatches/"
					+ FitnessWatch.getImage() + "' alt='' /></td>");
				pw.print("<td style='font-family: initial;font-size: 14px;'>$" + FitnessWatch.getPrice() + "</td>");
