...
public class VirtualReality extends HttpServlet{
	private String id;
	private String name;
	...
	public VirtualReality(String name, double price, String image, String retailer, String condition,double discount,double quantity,String manufacturerRebate){
		this.name=name;
		this.price=price;
		this.image=image;
		this.condition=condition;
