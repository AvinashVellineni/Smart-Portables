	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='phones' selected>Phones</option><option value='speakers'>Smart Speakers</option><option value='laptops'>Laptops</option><option value='fitnesswatches'>Fitness Watches</option><option value='smartwatches'>Smart Watches</option><option value='headphones'>Head Phones</option><option value='virtualrealities'>Virtual Reality</option><option value='trackers'>Tracker</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
