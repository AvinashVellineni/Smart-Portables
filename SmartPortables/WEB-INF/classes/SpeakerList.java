	...
	/* Checks the Tablets type whether it is microsft or apple or samsung */
		...
		for (Map.Entry<String, Speaker> entry : hm.entrySet()) {
			...
			if (i % 1 == 1)
				...
				pw.print("<td style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 14px;font-weight: bold;font-color: black !important;color: #d80a14;'>"+Speaker.getName()+"</td>");
				pw.print("<td id='item'><img style='padding-top: 10px;padding-bottom: 10px;margin-bottom: -3px;width: 80%;height: 150px;' src='images/speakers/"
					+ Speaker.getImage() + "' alt='' /></td>");
				pw.print("<td style='font-family: initial;font-size: 14px;'>$" + Speaker.getPrice() + "</td>");
