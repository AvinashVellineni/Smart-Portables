...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>");
		if(utility.isLoggedin()){
			pw.print("<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='retailer' disabled>Store Manager</option><option value='manager' disabled>Salesman</option></select>"
				+ "</td></tr></table>"
